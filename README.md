...
![CI](https://github.com/Worxchit/taskboard/actions/workflows/ci.yml/badge.svg)
![CD](https://github.com/Worxchit/taskboard/actions/workflows/cd.yml/badge.svg)
...
```bash
# Clone
git clone https://github.com/Worxchit/taskboard.git
cd taskboard
